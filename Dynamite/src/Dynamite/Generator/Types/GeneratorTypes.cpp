...
namespace Dynamite
{
	...
	// Main functions
	/////////////////////////////////////////////////////////////////
	TypeMetaData GeneratorTypes::GetType(llvm::LLVMContext& context, const Type& originalType)
	{
	...
	ValueMetaData GeneratorTypes::GetValue(llvm::LLVMContext& context, const Type& type, const std::string& value)
	{
		ValueMetaData returnValue = {};
